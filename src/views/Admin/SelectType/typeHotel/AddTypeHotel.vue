...
const createFacility = async () => {
  try {
    ...
    await axios.post('http://localhost:9999/HotelSleepGun/typeHotel/create', fd)
    alert('เพิ่มประเภทที่พักเรียบร้อยแล้ว')
    resetForm()
    fetch()
  } catch (err) {
    console.error(err)
...
const updateFacility = async () => {
  try {
    ...
    await axios.put(`http://localhost:9999/HotelSleepGun/typeHotel/update/${selectedId.value}`, fd)
    alert('อัปเดตประเภทที่พักเรียบร้อยแล้ว')
    resetForm()
    fetch()
  } catch (err) {
    console.error(err)
...
const deleteFacility = async (id) => {
  ...
  try {
    await axios.delete(`http://localhost:9999/HotelSleepGun/typeHotel/delete/${id}`)
    fetch()
  } catch (err) {
    console.error(err)
  }
