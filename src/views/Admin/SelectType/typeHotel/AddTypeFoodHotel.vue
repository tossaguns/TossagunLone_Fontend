...
const createFacility = async () => {
  try {
    ...
    await axios.post('http://localhost:9999/HotelSleepGun/typeFoodHotel/create', fd)
    alert('เพิ่มประเภทมื้ออาหารเรียบร้อยแล้ว')
    resetForm()
    fetch()
  } catch (err) {
    console.error(err)
...
const updateFacility = async () => {
  try {
    ...
    await axios.put(`http://localhost:9999/HotelSleepGun/typeFoodHotel/update/${selectedId.value}`, fd)
    alert('อัปเดตประเภทมื้ออาหารเรียบร้อยแล้ว')
    resetForm()
    fetch()
  } catch (err) {
    console.error(err)
...
const deleteFacility = async (id) => {
  ...
  try {
    await axios.delete(`http://localhost:9999/HotelSleepGun/typeFoodHotel/delete/${id}`)
    fetch()
  } catch (err) {
    console.error(err)
  }
