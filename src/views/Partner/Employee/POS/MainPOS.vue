<template>
          ...
          <div class="my-2">
            <div class="flex  items-start p-3 space-x-4">
              ...
              <div>
                ...
                <label class="font-bold text-amber-500 px-2 py-1 rounded-md">{{ getTotalAvailableRooms() }}</label>
              </div>
                ...
                <div class="text-sm font-semibold bg-stone-600 rounded-lg text-white">
                  <div class="my-2">
                    <div class="flex flex-col items-start p-3">
                      <div>
                        <label>จำนวนตึกทั้งหมด : </label>
                        <label class="font-bold text-amber-300 px-2 py-1 rounded-md">{{ posSummary.totalBuildingCount ||
                          0
                        }}</label>
                      </div>
                      <div>
                        <label>จำนวนห้องพักทั้งหมด : </label>
                        <label class="font-bold text-amber-300 px-2 py-1 rounded-md">{{ posSummary.totalRoomCount || 0
                        }}</label>
                      </div>
                      <div>
                      ...
                      <div v-if="room.status === 'SleepGunWeb'"
                        ...
                        <div class="relative w-full h-48">
                          <div class="absolute top-20 flex items-center justify-center w-full">
                            <span class="text-white text-lg font-bold bg-black bg-opacity-70 px-4 py-2 rounded-lg">
  ...
  <Drawer v-model:visible="isDrawerVisible" header="Check-In Order">
    <CheckInOrder />
  </Drawer>
</template>
